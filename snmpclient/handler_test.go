...
func TestHandleWalk(t *testing.T) {
	tests := []struct {
		...
		{
			name:       "MissingTarget",
			data:       map[string]interface{}{"root_oid": ".1.3.6.1.2.1"},
			wantStatus: http.StatusBadRequest,
		},
		{
			name:       "MissingRootOID",
		...
		{
			name:       "EmptyTarget",
			data:       map[string]interface{}{"target": "", "root_oid": ".1.3.6.1.2.1"},
			wantStatus: http.StatusBadRequest,
		},
		{
			name:       "EmptyRootOID",
			data:       map[string]interface{}{"target": "localhost", "root_oid": ""},
			wantStatus: http.StatusBadRequest,
		},
	}
